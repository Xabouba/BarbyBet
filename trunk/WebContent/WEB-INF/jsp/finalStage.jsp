...
<html lang="en">
    ...
    <div id="fb-root"></div>
                     			...
                     			<h2 class="widget-title"><span>Résultats</span></h2>
                                   <div class="menu-match">
                                   	<ul class="nav nav-tabs kp-tabs">
										<li id="nav-tab-8" class="active">
						                	<a onclick="selectGroup('4')" href="">Huitièmes de finales</a>
						            	</li>
									    <li id="nav-tab-4">
						                	<a onclick="selectGroup('5')" href="">Quart de finales</a>
						            	</li>
									    <li id="nav-tab-2">
						                	<a onclick="selectGroup('6')" href="">Demi-finales</a>
						            	</li>
									    <li id="nav-tab-1">
						                	<a onclick="selectGroup('7')" href="">Finale</a>
						            	</li>        	
						            </ul>
                                   </div>
					                <ul class="list-unstyled" id="group-information">
				                    	<%@include file='finalStage-part.jsp'%>
					                </ul>
	                    </div>
		                <!-- main-col -->
        ...
        <script type="text/javascript">
		  ...
		  selectGroup = function(stage)
		  {
			  $("#group-information").load("finalStage", {stage: stage}).fadeIn("slow");
		  }
